 ...
 *
 */
public class FileOperations<Writer extends OutputStream , Reader extends InputStream> {
	 ...
	 */
	public static <W extends OutputStream> ByteBuffer writeSize(W writer , int listSize) throws IOException {
		
		return writeSize(format.get() , writer , listSize);
