...
@RenderThreadOnly public abstract class CSSSBrush {
	 ...
	 */
	public void setupToolTip(SCElement thisBrushsElement) {
		
		if(thisBrushsElement.toolTip != null) thisBrushsElement.toolTip.shutDown();
		thisBrushsElement.initializeToolTip(TOOLTIP_HOVERING|TOOLTIP_MOUSE_PRESSED, MOUSE_RIGHT , 0 , textLength(toolTip));
		thisBrushsElement.toolTip.new SCDynamicRow(20).new SCText(toolTip);
