 ...
 *
 */
@RenderThreadOnly public class MoveLayerRankEvent extends CSSSEvent {
	...
	/**
	 * Creates a move layer rank event.
	 * 
	 * @param artboard — the artboard whose layer is being rearranged
	 * @param moveToThis — new rank to move this active layer to
	 */
